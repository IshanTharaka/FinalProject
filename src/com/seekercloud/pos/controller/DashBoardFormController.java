...
//            lblTime.setText(format.format(cal.getTime()));
    ...
    public void openOrderDetailsFormOnAction(MouseEvent mouseEvent) throws IOException {
        setUI("OrdersForm","Orders");
    }
